...
# The output is a CSV file with the averaged points and a CSV file with the fitted curve
# The input is the PDF-extracted data for a given drug-response curve
# The script assumes that the PDF-extracted data is in the "points_from_pdf" folder, and that the files are named like "drug_name_rep1.csv", "drug_name_rep2.csv", "drug_name_rep3.csv"
# The script also assumes that the data is in the "data/AGS_data/AGS_growth_data/drug_response_curves/{drug_name}/points_from_pdf/" folder
