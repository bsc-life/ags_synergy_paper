...
################################################################################
# This script plots the aggregated timing dynamics for a given synergy sweep experiment
# The input is the summary CSV file for the synergy sweep experiment
# The output is a grid of plots, with each plot showing the aggregated timing dynamics for a specific pair of diffusion coefficients
