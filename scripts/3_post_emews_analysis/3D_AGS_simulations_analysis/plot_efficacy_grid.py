...
################################################################################
# This script plots the efficacy grid for a given synergy sweep experiment
# The input is the summary CSV file for the synergy sweep experiment
# The output is a grid of plots, with each plot showing the efficacy vs. the timing difference for a specific pair of diffusion coefficients
# The script also plots the high-dose comparison, the detailed high-dose comparison, and the high-dose comparison with jitter
# This script generates the Figures SXYZ and XYZ from the Supplementary Materials for the paper
################################################################################
